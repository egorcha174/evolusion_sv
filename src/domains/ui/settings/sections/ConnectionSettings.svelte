<script lang="ts">
  ...
  import { isServerManagerOpen } from "../../store";
...
>
      ...
      <div class="server-info">
        ...
        <div class="server-details">
          <div class="server-name">
            {$appState.activeServer?.name || "Home Assistant"}
          </div>
  ...
  <div class="connection-actions">
    <button
      ...
      onclick={() => {
        console.log("ConnectionSettings: Opening Server Manager");
        isServerManagerOpen.set(true);
      }}
    >
