<script lang="ts">
  ...
  import { isThemeGeneratorOpen } from "../../store";
...
>
  ...
  <div class="theme-gallery-section">
    ...
    <div class="theme-grid">
            ...
            <div class="actions">
              ...
              {#if theme.theme.isCustom}
                <button
                  ...
                  title={isBuiltIn ? "Reset" : "Delete"}
                >
                  <iconify-icon icon={isBuiltIn ? "mdi:refresh" : "mdi:delete"}
                  ></iconify-icon>
                </button>
              {/if}
            </div>
      ...
      <button
        class="theme-card create-btn highlight"
        onclick={() => isThemeGeneratorOpen.set(true)}
      >
      ...
      <button
        class="theme-card create-btn"
        onclick={() => createThemeCopy(defaultTheme)}
      >
