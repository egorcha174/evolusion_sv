  ...
  >
    ...
    <div class="drawer-content">
      <div class="scroll-inner">
        ...
        >
            ...
            <div class="theme-grid">
              {#each allThemes as theme (theme.theme.id)}
                ...
                >
                  <div
                    class="preview"
                    style:background={theme.theme.scheme.light.dashboardBackgroundColor1}
                  >
                    <div
                      class="mini-card"
          ...
          {#if isEditingTheme && themeDraft}
            <div class="editor-wrapper" transition:slide>
              <ThemeEditor draft={themeDraft} onSave={saveTheme} onCancel={cancelThemeEdit} />
            </div>
          {/if}
        </Section>
        ...
        <Section title="Widgets" description="Weather and Clock settings" initiallyOpen={true}>
          ...
          {#if wShowForecast}
            <div transition:slide>
              <RangeInput
                label={$t('settings.forecast.daysLabel')}
                bind:value={wDays}
                min={1}
                max={7}
              />
          ...
          />
          <RangeInput
            label="Temp Size (Current)"
            bind:value={wTempSize}
            min={16}
            max={96}
            step={2}
            unit="px"
          ...
          {#if wShowForecast}
            ...
            />
            <RangeInput
              label="Temp Size (Forecast)"
              bind:value={wForecastTempSize}
              min={10}
              max={32}
              step={1}
              unit="px"
          ...
          <div class="actions">
            <button class="btn secondary small" onclick={saveWeatherConfig}
              >{$t('settings.updateWeather')}</button
            >
          </div>
        </Section>
        ...
        <div class="footer-info">Evolusion v0.0.1</div>
      </div>
    </div>
  </aside>
{/if}
