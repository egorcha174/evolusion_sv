...
<div class="entity-row" data-domain={domain}>
  ...
  {#if isToggleable}
    <button onclick={handleToggle} disabled={isToggling} class="action-button">
...
<style>
  ...
  .entity-row[data-domain='light'] {
    border-left: 4px solid #ffc107;
  }
  .entity-row[data-domain='switch'] {
    border-left: 4px solid #2196f3;
  }
  .entity-row[data-domain='sensor'] {
    border-left: 4px solid #4caf50;
  }
  .entity-row[data-domain='binary_sensor'] {
    border-left: 4px solid #8bc34a;
  }
  .entity-row[data-domain='climate'] {
    border-left: 4px solid #ff9800;
  }
  .entity-row[data-domain='cover'] {
    border-left: 4px solid #9c27b0;
  }
  .entity-row[data-domain='media_player'] {
    border-left: 4px solid #3f51b5;
  }
  .entity-row[data-domain='lock'] {
