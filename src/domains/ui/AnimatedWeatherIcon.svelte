<script lang="ts">
	...
	const { iconCode, iconPack, class: className, style } = $props<{
		iconCode: string;
	...
	// Mapping of OpenWeatherMap icon codes to Iconify icons, animations, and colors
	...
	const owmToMaterialSymbols: Record<string, string> = {
		'01d': 'material-symbols-light:sunny',
		'01n': 'material-symbols-light:clear-night',
		'02d': 'material-symbols-light:partly-cloudy-day',
		'02n': 'material-symbols-light:partly-cloudy-night',
		'03d': 'material-symbols-light:cloudy',
		'03n': 'material-symbols-light:cloudy',
		'04d': 'material-symbols-light:cloudy',
		'04n': 'material-symbols-light:cloudy',
		'09d': 'material-symbols-light:rainy',
		'09n': 'material-symbols-light:rainy',
		'10d': 'material-symbols-light:rainy',
		'10n': 'material-symbols-light:rainy',
		'11d': 'material-symbols-light:thunderstorm',
		'11n': 'material-symbols-light:thunderstorm',
		'13d': 'material-symbols-light:cloudy-snowing',
		'13n': 'material-symbols-light:cloudy-snowing',
		'50d': 'material-symbols-light:foggy',
		'50n': 'material-symbols-light:foggy'
	};
	...
	$effect(() => {
		const fallbackData = defaultIconMap['01d']; // Default fallback

		if (iconPack === 'default') {
			const { icon, animation, color } = defaultIconMap[iconCode] || fallbackData;
			iconName = icon;
			animationClass = animation;
			colorClass = color;
		} else {
			animationClass = ''; // No animation for other packs by default
			colorClass = 'text-gray-600 dark:text-gray-300'; // Default color for other packs
			switch (iconPack) {
				case 'meteocons':
				...
				default:
					...
					animationClass = fallbackData.animation;
			}
		}
	});
</script>
...
<div class="relative {className || ''}" {style}>
	<Icon icon={iconName} class="w-full h-full {animationClass} {colorClass}" />
</div>
