<script lang="ts">
  ...
  function handlePointerDown(e: PointerEvent, el: CardElement) {
    ...
    templateEditorState.startDrag(el.id, e.clientX, e.clientY, el.x, el.y);
  ...
  function handlePointerMove(e: PointerEvent) {
    ...
    const { draggingId, dragStartX, dragStartY, elementStartX, elementStartY } =
      $templateEditorState;
  ...
  async function handleImport(e: Event) {
    ...
    if (file) {
      try {
        ...
        alert($t('templates.editor.alertImport') + err);
      }
    }
  }
  ...
  <div class="editor-window">
    ...
    <header class="editor-header">
      ...
      <div class="header-right">
        <button class="btn secondary" onclick={triggerImport} type="button" aria-label="Import"
          ><iconify-icon icon="mdi:upload"></iconify-icon>
          {$t('templates.editor.importJson')}</button
        >
        <button class="btn secondary" onclick={handleExport} type="button" aria-label="Export"
          ><iconify-icon icon="mdi:download"></iconify-icon>
          {$t('templates.editor.exportJson')}</button
        >
      ...
      <div class="canvas-area">
        <div class="canvas-wrapper">
          ...
          <div
            class="card-canvas"
            bind:this={canvasRef}
            style:background-color={template.style.backgroundType === 'color'
      ...
      <div class="properties-pane">
        <div class="tabs">
          ...
          <button
            ...
            type="button">{$t('templates.editor.tabStyle')}</button
          >
        </div>
            ...
            {#if selectedElement}
              ...
              {#if selectedElement.type === 'shape'}
                ...
                <div class="prop-group">
                  ...
                  <input
                    type="color"
                    bind:value={selectedElement.style.backgroundColor}
