...
// Helper to define common values if needed, but strict contract requires full implementation per palette
// We will implement explicit palettes for clarity and robustness.
...
// --- MATERIAL THEME ---
const materialLight: ThemePalette = {
  ...defaultLight,
  bgPage: '#fff',
  bgCard: '#f5f5f5',
