...
function DeviceCard($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    $$renderer2.push(`<!--]--> `);
    if (entity.attributes.temperature !== void 0) {
      $$renderer2.push("<!--[-->");
      $$renderer2.push(`<div class="attribute svelte-vmg48c">${escape_html(entity.attributes.temperature)}°</div>`);
    } else {
      $$renderer2.push("<!--[!-->");
    }
...
function DashboardGrid($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    if (items.length === 0) {
      $$renderer2.push("<!--[-->");
      $$renderer2.push(`<div class="empty-state svelte-wf2j5s">No dashboard devices found. Add lights, switches, or media players to Home Assistant.</div>`);
    } else {
      $$renderer2.push("<!--[!-->");
