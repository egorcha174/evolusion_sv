import { d as attr, b as store_get, e as ensure_array_like, u as unsubscribe_stores } from "../../chunks/index2.js";
import { e as extractDomain, a as activeTabId, h as haStore } from "../../chunks/store.js";
...
function DeviceCard($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    $$renderer2.push(`<div class="card svelte-vmg48c"${attr("data-domain", domain)}${attr("data-state", isOn ? "on" : "off")}>`);
    {
      $$renderer2.push("<!--[-->");
