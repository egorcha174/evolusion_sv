import { s as store_get, e as ensure_array_like, d as attr, u as unsubscribe_stores } from "../../../chunks/index2.js";
import { b as themeSettings, B as BUILTIN_THEMES } from "../../../chunks/store2.js";
...
function _page($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    $$renderer2.select(
      {
        id: "theme-select",
        value: store_get($$store_subs ??= {}, "$themeSettings", themeSettings).activeThemeId,
        onchange: handleThemeChange,
        class: ""
      },
      ($$renderer3) => {
        $$renderer3.push(`<!--[-->`);
        const each_array = ensure_array_like(BUILTIN_THEMES);
